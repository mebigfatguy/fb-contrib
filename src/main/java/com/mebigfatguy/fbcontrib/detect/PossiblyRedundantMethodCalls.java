...
public class PossiblyRedundantMethodCalls extends BytecodeScanningDetector {
    ...
    // @formatter:off
            ...
            new FQMethod("java/lang/Integer", "longValue", "()J"),
            new FQMethod("java/lang/Long", "intValue", "()I"), 
            ...
            new FQMethod("java/lang/Double", "intValue", "()I"),
            new FQMethod("java/lang/Double", "longValue", "()J"),
            new FQMethod("java/lang/StringBuilder", "length", "()I"), 
            new FQMethod("java/lang/StringBuffer", "length", "()I"),
            new FQMethod("java/math/BigDecimal", "doubleValue", "()D"),
            new FQMethod("java/math/BigDecimal", "longValue", "()J"),
            new FQMethod("java/math/BigDecimal", "valueOf", "(J)Ljava/math/BigDecimal;"),
