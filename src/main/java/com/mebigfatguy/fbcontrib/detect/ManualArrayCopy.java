...
public class ManualArrayCopy extends BytecodeScanningDetector {
    enum State {
        SAW_NOTHING, SAW_ICMP, SAW_ARRAY1_LOAD, SAW_ARRAY1_INDEX, SAW_ARRAY2_LOAD, SAW_ARRAY2_INDEX, SAW_ELEM_LOAD,
        SAW_ELEM_STORE
    }
    ...
    /**
     * implements the visitor to find loops where array elements are copied to
     * another array
     *
