...
public class OverzealousCasting extends BytecodeScanningDetector {
    ...
    /**
     * implements the visitor to look for a checkcast followed by a astore, where
     * the types of the objects are different.
     *
            ...
            if (OpcodeUtils.isAStore(seen)) {
                ...
                if (lv != null) {
                    ...
                    if (!sig.equals(castClass)) {
                        bugReporter
                                .reportBug(new BugInstance(this, BugType.OC_OVERZEALOUS_CASTING.name(), NORMAL_PRIORITY)
