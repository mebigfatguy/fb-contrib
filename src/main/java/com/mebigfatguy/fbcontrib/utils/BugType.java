...
public enum BugType {
    ...
    MK_UNNEEDED_VALIDATEMOCKITOUSAGE,
    ...
    MUI_RETURNING_MUTABLE_STATIC_MAP,
    MUI_USE_COMPUTEIFABSENT,
    MUI_USE_CONTAINSKEY,
    ...
    OI_OPTIONAL_ISSUES_OR_ELSE_NULL_CALL,
    ...
    SUI_RETURNING_MUTABLE_STATIC_MAP,
    ...
    UTAO_JUNIT_ASSERTION_ODDITIES_NESTED_STATIC_CLASS,
    ...
    UTAO_JUNIT_ASSERTION_ODDITIES_PRIVATE_ANNOTATED_METHOD,
