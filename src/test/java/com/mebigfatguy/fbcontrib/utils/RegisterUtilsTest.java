...
public class RegisterUtilsTest {
    ...
    public void setUpClass() {
        FindBugs.setHome("lib/spotbugs-4.9.8.jar");
    }
    ...
    public void shouldGetParameterRegisters(int accessFlags, String signature, int[] expected) {
        ...
        Constant[] cnst = new Constant[] { new ConstantClass(1), new ConstantUtf8("ex/RegisterUtilsTestData"), new ConstantUtf8(signature) };
