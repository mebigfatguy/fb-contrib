 ...
 * used before java added Enum support to the language. Since this class is compiled with
 * java 1.5 or later, it would be simpler to just use java enums
 */
public class DeprecatedTypesafeEnumPattern extends BytecodeScanningDetector 
{
	 ...
	 * are the same type as the owning class. it collects these object names for later
	 * 
	...
	public void visitField(Field obj) {
		...
		&&  ((accessFlags & Constants.ACC_PUBLIC) != 0)
		&&  ((accessFlags & Constants.ACC_FINAL) != 0)) {
