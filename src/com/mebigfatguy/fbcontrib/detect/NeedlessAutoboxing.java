                ...
                if (seen == INVOKEVIRTUAL) {
                    ...
                    if (boxSigs.getPrimitiveValueSignature().equals(getNameConstantOperand() + getSigConstantOperand())) {
                        bugReporter.reportBug(new BugInstance(this, BugType.NAB_NEEDLESS_BOX_TO_UNBOX.name(), NORMAL_PRIORITY).addClass(this).addMethod(this)
                                .addSourceLine(this));
                    } else if (getSigConstantOperand().startsWith(new SignatureBuilder().withReturnType("").toString()) && getNameConstantOperand().endsWith("Value")) {
            ...
            case INVOKESTATIC:
                ...
                if (boxSigs != null) {
                    if ("valueOf".equals(getNameConstantOperand())) {
                        ...
                        if (sig.startsWith(new SignatureBuilder().withParamTypes(Values.SLASHED_JAVA_LANG_STRING).withReturnType("").toString())) {
